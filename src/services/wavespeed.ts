...
export async function generateImageWan22(options: GenerateImageWan22Options): Promise<PredictionResponse> {
  ...
  const highNoiseLoras = hasTrigger ? [
    ...
    {
      path: 'https://huggingface.co/lopi999/Wan2.2-I2V_General-NSFW-LoRA/resolve/main/NSFW-22-H-e8.safetensors',
      scale: 1,
    },
  ] : [];
  ...
  const lowNoiseLoras = hasTrigger ? [
    ...
    {
      path: 'https://huggingface.co/lopi999/Wan2.2-I2V_General-NSFW-LoRA/resolve/main/NSFW-22-L-e8.safetensors',
      scale: 1,
    },
  ] : [];
